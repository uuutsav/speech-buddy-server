// import {extractSentences} from '../utils/ExtractSentencesFromParagraph'

// only first 100 lines extracted 
const str =
    `
...
It’s believed that Orlando Bloom has swinophobia, which is a fear of pigs! He was seen running away from a pig on the set of Kingdom of Heaven.
...
Of the 9,000 Blockbuster stores that existed in the early 1990s, only one remains. The last Blockbuster on Earth can be found in Bend, Oregon, USA.
...
Kosher salt is salt traditionally used for koshering meat, a process that removes the blood from it. It’s also fantastic for cooking with, as it contains no iodine or anti-clumping agents!
...
The shower-curtain effect is the phenomenon in which a shower curtain gets blown inward with a running shower. While there are multiple theories as to why this happens, there is no one agreed-upon solution.
...
This term was used to refer to the guard who sat next to the Stagecoach driver. The guards would use a shotgun to keep robbers and criminals away. It made its way into society due to Hollywood’s love of Western flicks.
